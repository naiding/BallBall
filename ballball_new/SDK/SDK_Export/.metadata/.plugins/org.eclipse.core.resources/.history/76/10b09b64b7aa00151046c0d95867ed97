	...
	while (1) {
		...
		if(stop == 0){
					...
					(RxBuffer == 0x69) || (RxBuffer == 0x72) || (RxBuffer == 0x7A))
			{
				...
				{
					mode = 1;
					XTft_SetPos(&TftInstance, 0,28);
					XTft_Write(&TftInstance, 'M');
					XTft_SetPos(&TftInstance, 15,28);
					XTft_Write(&TftInstance, 'O');
					XTft_SetPos(&TftInstance, 30,28);
					XTft_Write(&TftInstance, 'D');
					XTft_SetPos(&TftInstance, 45,28);
					XTft_Write(&TftInstance, 'E');
					XTft_SetPos(&TftInstance, 60,28);
